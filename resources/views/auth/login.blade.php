...
<div class="sk-au-main-container">

    <div class="sk-au-container">

        <div class="sk-au-flex">
            <div class="sk-au-left-column">
                <div class="w-full relative text-primary">
                    <svg class="absolute bottom-0 right-0 mb-2 p-4" id="a5c16198-98a1-478b-8909-43624583dcf2" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 793 551.73152" fill="currentColor">
                        ...
                        <path d="M409.41752,423.55243c-27.13873,18.49308-46.31418.63272-60.94729-26.92346,2.03338-16.86188-1.259-37.04061-7.35672-58.96635a40.13762,40.13762,0,0,1,24.50567-48.40124h0l32.06116,13.421c27.22362,22.19038,32.582,46.227,22.36825,71.5784Z" transform="translate(-203.5 -174.13424)" fill="currentColor" />
                        ...
                        <path d="M361.14557,329.52422c-12.43861-5.4511-23.74934.47044-38.026,5.21926l-2.23683-39.51725c14.17612-7.55568,27.69209-9.59281,40.26285-3.728Z" transform="translate(-203.5 -174.13424)" fill="currentColor" />
            ...
            <div class="sk-au-right-column">
                <div class="py-2 px-6 mb-0">

                    <div class="sk-au-logo">
                        @include('auth.layouts.logo')
                    </div>

                    <div class="sk-au-title">
                        Login
                    </div>

                    @if ($errors->any())
                    <div class="sk-au-errors-container">
                        <ul>
                    ...
                    @if(session('status'))
                    <div class="sk-au-status-container">
                        {!! session('status') !!}
                    </div>
                    @endif
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="my-6">
                            <label for="email" class="block text-sm font-bold mb-2">Mailadresse</label>

                            <input id="email" type="email" class="form-input shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:ring @error('email') border-red-500 @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>

                            @error('email')
                            <div class="bg-red-500 text-gray-100 text-xs mt-4 py-1 px-3 rounded">
                        ...
                        <div class="mb-6">
                            <label for="password" class="block text-sm font-bold mb-2">Kennwort</label>

                            <input id="password" type="password" class="form-input shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:ring @error('password') border-red-500 @enderror" name="password" required autocomplete="current-password">
                        ...
                        <div class="flex mb-6 items-center">
                            <input class="form-checkbox text-primary bg-white" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
                            <label class="text-sm ml-3" for="remember">
                                Erinnere Dich an mich
                            </label>
                        </div>

                        <div class="sk-au-button-container">
                            <button type="submit" class="sk-au-button">
                                Login
                            </button>

                            @if (Route::has('password.request'))
                            <div class="mt-4 md:mt-0">
                                <a class="sk-au-link" href="{{ route('password.request') }}">
                                    Kennwort vergessen?
                                </a>
                            </div>
                            @endif
        ...
        <div class="p-2 w-full max-w-3xl">
